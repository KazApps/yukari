...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>) -> i32 {
        ...
        let (try_probcut_beta, a, b, sigma, s) = match (depth, piece_count) {
            (1, 0) => (true, 1.0252869, 15.1492064, 51.0520368, 0), // R² = 0.970577
            (1, 1) => (true, 1.0507307, -4.6583063, 61.1149298, 0), // R² = 0.966735
            (1, 2) => (true, 1.0239908, 4.8782359, 53.1618307, 0), // R² = 0.976098
            (1, 3) => (true, 1.0193669, 12.3135830, 42.9008168, 0), // R² = 0.974907
            (2, 0) => (true, 1.0486334, 10.3478001, 63.8502822, 0), // R² = 0.956634
            (2, 1) => (true, 1.0457716, 5.2340788, 65.0067545, 0), // R² = 0.962184
            (2, 2) => (true, 1.0267263, 5.7928469, 63.5578345, 0), // R² = 0.966356
            (2, 3) => (true, 1.0298758, 6.7637442, 52.2473246, 0), // R² = 0.963947
            (3, 0) => (true, 1.0745089, 11.6070644, 71.7496514, 0), // R² = 0.948300
            (3, 1) => (true, 1.0860172, -5.3286865, 79.8646160, 0), // R² = 0.947862
            (3, 2) => (true, 1.0479199, 1.2703850, 74.2660419, 0), // R² = 0.956360
            (3, 3) => (true, 1.0431730, 8.6613251, 59.1528886, 0), // R² = 0.955359
            (4, 0) => (true, 1.0611005, -4.5948201, 59.3107400, 1), // R² = 0.965931
            (4, 1) => (true, 1.0320029, 7.0788128, 67.5403717, 1), // R² = 0.963248
            (4, 2) => (true, 1.0257294, -0.7617608, 63.2634367, 1), // R² = 0.968831
            (4, 3) => (true, 1.0265289, -5.2499137, 49.1900310, 1), // R² = 0.969644
            (5, 0) => (true, 1.0869210, -5.5946398, 65.2736066, 1), // R² = 0.960879
            (5, 1) => (true, 1.0656229, 0.4919780, 71.6431047, 1), // R² = 0.961294
            (5, 2) => (true, 1.0435366, -4.2900165, 67.7763281, 1), // R² = 0.965553
            (5, 3) => (true, 1.0378744, -5.2181850, 52.2774548, 1), // R² = 0.966565
