...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count) {
            ...
            (2, 3) => (true, true, 1.0298758, 6.7637442, 52.2473246, 0), // R² = 0.963947
            (3, 0) => (true, false, 1.0745089, 11.6070644, 71.7496514, 0), // R² = 0.948300
            (3, 1) => (true, false, 1.0860172, -5.3286865, 79.8646160, 0), // R² = 0.947862
            ...
            (4, 3) => (true, true, 1.0265289, -5.2499137, 49.1900310, 1), // R² = 0.969644
            ...
            (5, 3) => (true, true, 1.0378744, -5.2181850, 52.2774548, 1), // R² = 0.966565
