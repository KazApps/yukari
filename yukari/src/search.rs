...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count) {
            (1, 0) => (true, true, 1.0254142, 18.9976233, 51.0520498, 0), // R² = 0.952481
            (1, 1) => (true, true, 1.0494631, 7.0623503, 61.1162402, 0), // R² = 0.958708
            (1, 2) => (true, true, 1.0241663, 11.8684535, 53.1618651, 0), // R² = 0.967176
            (1, 3) => (true, true, 1.0189495, 14.7817636, 42.9009565, 0), // R² = 0.968468
            (2, 0) => (true, false, 1.0527860, 11.2049589, 63.8613251, 0), // R² = 0.939359
            (2, 1) => (true, false, 1.0457527, 7.5986591, 65.0067546, 0), // R² = 0.952557
            (2, 2) => (true, false, 1.0291080, 7.3199675, 63.5627639, 0), // R² = 0.956752
            (2, 3) => (true, false, 1.0323477, 7.2111236, 52.2513480, 0), // R² = 0.958546
            (3, 0) => (true, false, 1.0789979, 16.4845429, 71.7611355, 0), // R² = 0.916207
            (3, 1) => (true, false, 1.0849624, 5.9097683, 79.8652974, 0), // R² = 0.929017
            (3, 2) => (true, false, 1.0518687, 8.7071805, 74.2776195, 0), // R² = 0.937185
            (3, 3) => (true, false, 1.0478373, 11.3824315, 59.1655415, 0), // R² = 0.943713
            (4, 0) => (true, false, 1.0660847, -5.5764499, 59.3292881, 1), // R² = 0.958285
            (4, 1) => (true, false, 1.0390439, 4.8112721, 67.5819085, 1), // R² = 0.957941
            (4, 2) => (true, false, 1.0291363, -1.9208385, 63.2742510, 1), // R² = 0.964426
            (4, 3) => (true, false, 1.0285555, -5.5459221, 49.1930929, 1), // R² = 0.968015
            (5, 0) => (true, false, 1.0915887, -5.5298665, 65.2883882, 1), // R² = 0.952077
            (5, 1) => (true, false, 1.0685322, -0.2437622, 71.6498415, 1), // R² = 0.954991
            (5, 2) => (true, false, 1.0451679, -4.5267562, 67.7786344, 1), // R² = 0.960582
            (5, 3) => (true, false, 1.0396188, -5.3496275, 52.2795893, 1), // R² = 0.964718
