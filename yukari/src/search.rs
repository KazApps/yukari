...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count) {
            ...
            (1, 1) => (true, true, 1.0238183, 12.3616982, 53.8073167, 0), // R² = 0.972285
            (1, 2) => (true, true, 1.0573635, -5.5422897, 62.4773855, 0), // R² = 0.963515
            (1, 3) => (true, true, 1.0454165, -3.8567743, 59.7351255, 0), // R² = 0.969538
            ...
            (2, 0) => (true, false, 1.0877918, 6.7156531, 52.2337368, 0), // R² = 0.947306
            (2, 1) => (true, false, 1.0427330, 11.9068636, 67.4239316, 0), // R² = 0.958636
            (2, 2) => (true, false, 1.0554061, 5.4014344, 65.7277111, 0), // R² = 0.959633
            ...
            (2, 7) => (true, false, 1.0512562, 6.0204493, 42.8450956, 0), // R² = 0.939612
            (3, 0) => (true, false, 1.1204089, 15.2433987, 59.6096447, 0), // R² = 0.936078
            (3, 1) => (true, false, 1.0669160, 10.4123136, 75.5648197, 0), // R² = 0.950779
            (3, 2) => (true, false, 1.0984761, -5.0017265, 80.8153253, 0), // R² = 0.944551
            (3, 3) => (true, false, 1.0757725, -5.6967136, 78.8118919, 0), // R² = 0.950887
            (3, 4) => (true, false, 1.0527013, 2.5687832, 76.7156437, 0), // R² = 0.955382
            (3, 5) => (true, false, 1.0428843, 0.0562657, 71.6142503, 0), // R² = 0.957406
            (3, 6) => (true, false, 1.0420532, 8.4997916, 60.5884350, 0), // R² = 0.956603
            (3, 7) => (true, false, 1.0659071, 9.4985162, 47.0339858, 0), // R² = 0.929942
            (4, 0) => (true, false, 1.1165909, -15.3294018, 52.7145159, 1), // R² = 0.953590
            ...
            (4, 7) => (true, false, 1.0447452, -1.8245044, 39.2157167, 1), // R² = 0.952577
            (5, 0) => (true, false, 1.1511214, -13.0090771, 57.9122404, 1), // R² = 0.947626
            ...
            (5, 7) => (true, false, 1.0562997, 0.0625395, 41.8399300, 1), // R² = 0.947476
