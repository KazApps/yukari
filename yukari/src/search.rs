...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count) {
            (1, 0) => (true, true, 1.0305786, 22.4894021, 42.0675256, 0), // R² = 0.961357
            (1, 1) => (true, false, 1.0238183, 12.3616982, 53.8073167, 0), // R² = 0.972285
            (1, 2) => (false, false, 1.0573635, -5.5422897, 62.4773855, 0), // R² = 0.963515
            (1, 3) => (true, false, 1.0454165, -3.8567743, 59.7351255, 0), // R² = 0.969538
            (1, 4) => (true, false, 1.0276826, 7.2244097, 55.1053668, 0), // R² = 0.975340
            (1, 5) => (true, true, 1.0204352, 2.5781664, 50.9741591, 0), // R² = 0.976999
            (1, 6) => (true, true, 1.0192183, 12.7287100, 44.0449151, 0), // R² = 0.975552
            (1, 7) => (true, true, 1.0260494, 9.1655839, 33.0535348, 0), // R² = 0.961397
            (2, 0) => (true, true, 1.0877918, 6.7156531, 52.2337368, 0), // R² = 0.947306
            ...
            (2, 4) => (false, false, 1.0271596, 6.7880485, 64.8246867, 0), // R² = 0.966160
            (2, 5) => (true, false, 1.0264870, 4.7928960, 62.2148211, 0), // R² = 0.966503
            (2, 6) => (true, true, 1.0289041, 6.8204524, 53.3753187, 0), // R² = 0.965146
            (2, 7) => (true, true, 1.0512562, 6.0204493, 42.8450956, 0), // R² = 0.939612
            (3, 0) => (true, false, 1.1204089, 15.2433987, 59.6096447, 0), // R² = 0.936078
            (3, 1) => (false, false, 1.0669160, 10.4123136, 75.5648197, 0), // R² = 0.950779
            (3, 2) => (false, false, 1.0984761, -5.0017265, 80.8153253, 0), // R² = 0.944551
            (3, 3) => (false, false, 1.0757725, -5.6967136, 78.8118919, 0), // R² = 0.950887
            (3, 4) => (false, false, 1.0527013, 2.5687832, 76.7156437, 0), // R² = 0.955382
            (3, 5) => (false, false, 1.0428843, 0.0562657, 71.6142503, 0), // R² = 0.957406
            (3, 6) => (true, false, 1.0420532, 8.4997916, 60.5884350, 0), // R² = 0.956603
            (3, 7) => (true, true, 1.0659071, 9.4985162, 47.0339858, 0), // R² = 0.929942
            (4, 0) => (true, true, 1.1165909, -15.3294018, 52.7145159, 1), // R² = 0.953590
            ...
            (4, 6) => (true, true, 1.0254826, -5.7650339, 50.3522701, 1), // R² = 0.970513
            (4, 7) => (true, true, 1.0447452, -1.8245044, 39.2157167, 1), // R² = 0.952577
            (5, 0) => (true, true, 1.1511214, -13.0090771, 57.9122404, 1), // R² = 0.947626
            (5, 1) => (true, false, 1.0772592, -2.8993755, 66.9794336, 1), // R² = 0.964314
            (5, 2) => (true, false, 1.0745356, 2.0312202, 71.1933486, 1), // R² = 0.960583
            (5, 3) => (false, false, 1.0579409, -0.9965567, 71.9473140, 1), // R² = 0.962005
            (5, 4) => (true, false, 1.0468408, -5.5946631, 70.8823211, 1), // R² = 0.964107
            (5, 5) => (true, false, 1.0395305, -2.9061407, 64.3691657, 1), // R² = 0.967169
            (5, 6) => (true, true, 1.0367345, -5.9854095, 53.4743744, 1), // R² = 0.967560
            (5, 7) => (true, true, 1.0562997, 0.0625395, 41.8399300, 1), // R² = 0.947476
