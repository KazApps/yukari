...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>, mut probcut_failed: bool) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count, probcut_failed) {
            ...
            (4, 0, false) => (true, false, 1.0911152, 11.6437996, 77.0, 0), // R² = 0.943003
            (4, 1, false) => (true, false, 1.0925395, 2.8585164, 82.0, 0), // R² = 0.945347
            (4, 2, false) => (true, false, 1.0537109, 4.4562321, 79.0, 0), // R² = 0.951754
            (4, 3, false) => (true, false, 1.0491882, 7.4400344, 63.0, 0), // R² = 0.950339
            (4, 0, true) => (true, false, 1.0611005, -4.5948201, 59.0, 1), // R² = 0.965931
            (4, 1, true) => (true, false, 1.0320029, 7.0788128, 68.0, 1), // R² = 0.963248
            (4, 2, true) => (true, false, 1.0257294, -0.7617608, 63.0, 1), // R² = 0.968831
            (4, 3, true) => (true, false, 1.0265289, -5.2499137, 49.0, 1), // R² = 0.969644
