...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>, mut probcut_failed: bool) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count, probcut_failed) {
            ...
            (6, 0, false) => (true, false, 1.1364423, 12.2529298, 87.5078655, 0), // R² = 0.932403
            (6, 1, false) => (true, false, 1.1377696, 1.6500130, 94.7987336, 0), // R² = 0.934047
            (6, 2, false) => (true, false, 1.0798398, 3.5165592, 88.4969308, 0), // R² = 0.942489
            (6, 3, false) => (true, false, 1.0672290, 7.4649500, 69.1925696, 0), // R² = 0.942432
