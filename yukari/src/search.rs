...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry]) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match depth {
            ...
            3 => (true, false, 1.070_297_8, 4.639_024_3, 76.791_084, 0),
            4 => (true, false, 1.041_830_2, 1.444_724_8, 66.839_806, 1),
            5 => (true, false, 1.067_465_2, -2.160_964_3, 69.372_375, 1), // R² = 0.9625
            //8 => (true, 1.0417771,   1.3685266,  94.86876, 4),
            _ => (false, false, 0.0, 0.0, 0.0, 0),
        };
        if !self.board[ply].in_check() && alpha >= -1000 && beta <= 1000 && !expected_pvnode && try_probcut_beta && tt_complexity <= 500 {
        ...
        if !self.board[ply].in_check() && alpha >= -1000 && beta <= 1000 && !expected_pvnode && try_probcut_alpha && tt_complexity <= 500 {
