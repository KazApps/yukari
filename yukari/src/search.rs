...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>) -> i32 {
        ...
        let piece_count = (self.board[ply].data().piecemask().occupied().count_ones() as usize - 2) / 4;
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count) {
            (1, 0) => (true, false, 1.0305786, 22.4894021, 42.0675256, 0), // R² = 0.961357
            (1, 1) => (true, false, 1.0238183, 12.3616982, 53.8073167, 0), // R² = 0.972285
            (1, 2) => (true, false, 1.0573635, -5.5422897, 62.4773855, 0), // R² = 0.963515
            (1, 3) => (true, false, 1.0454165, -3.8567743, 59.7351255, 0), // R² = 0.969538
            (1, 4) => (true, true, 1.0276826, 7.2244097, 55.1053668, 0), // R² = 0.975340
            (1, 5) => (true, true, 1.0204352, 2.5781664, 50.9741591, 0), // R² = 0.976999
            (1, 6) => (true, true, 1.0192183, 12.7287100, 44.0449151, 0), // R² = 0.975552
            (1, 7) => (true, false, 1.0260494, 9.1655839, 33.0535348, 0), // R² = 0.961397
            (2, 0) => (false, false, 1.0877918, 6.7156531, 52.2337368, 0), // R² = 0.947306
            (2, 1) => (false, false, 1.0427330, 11.9068636, 67.4239316, 0), // R² = 0.958636
            (2, 2) => (false, false, 1.0554061, 5.4014344, 65.7277111, 0), // R² = 0.959633
            (2, 3) => (true, false, 1.0378607, 5.0300761, 64.2118932, 0), // R² = 0.964472
            (2, 4) => (true, false, 1.0271596, 6.7880485, 64.8246867, 0), // R² = 0.966160
            (2, 5) => (true, false, 1.0264870, 4.7928960, 62.2148211, 0), // R² = 0.966503
            (2, 6) => (true, false, 1.0289041, 6.8204524, 53.3753187, 0), // R² = 0.965146
            (2, 7) => (false, false, 1.0512562, 6.0204493, 42.8450956, 0), // R² = 0.939612
            (3, 0) => (true, false, 1.0817133, -9.2832051, 44.7565628, 1), // R² = 0.963964
            (3, 1) => (true, true, 1.0406190, -2.5383817, 53.7315028, 1), // R² = 0.975113
            (3, 2) => (true, false, 1.0353874, 0.4984282, 55.6614534, 1), // R² = 0.973695
            (3, 3) => (true, false, 1.0258195, -2.0051610, 56.6383956, 1), // R² = 0.974628
            (3, 4) => (true, true, 1.0221500, -4.9881322, 57.0399142, 1), // R² = 0.975337
            (3, 5) => (true, true, 1.0204470, -2.6538353, 52.6382848, 1), // R² = 0.976985
            (3, 6) => (true, true, 1.0205308, -4.5310727, 44.1228116, 1), // R² = 0.976985
            (3, 7) => (true, false, 1.0364547, 0.0183146, 34.2573719, 1), // R² = 0.962834
            (4, 0) => (false, false, 1.1165909, -15.3294018, 52.7145159, 1), // R² = 0.953590
            (4, 1) => (true, false, 1.0532564, -0.6066921, 60.5661006, 1), // R² = 0.969317
            (4, 2) => (true, false, 1.0387705, 8.3917278, 67.4441392, 1), // R² = 0.962088
            (4, 3) => (true, false, 1.0261549, 5.8128785, 67.5577907, 1), // R² = 0.964308
            (4, 4) => (true, false, 1.0254801, -1.8326300, 65.9032554, 1), // R² = 0.967551
            (4, 5) => (true, false, 1.0257982, 0.3228432, 60.4144144, 1), // R² = 0.970206
            (4, 6) => (true, false, 1.0254826, -5.7650339, 50.3522701, 1), // R² = 0.970513
            (4, 7) => (false, false, 1.0447452, -1.8245044, 39.2157167, 1), // R² = 0.952577
            (5, 0) => (false, false, 1.1511214, -13.0090771, 57.9122404, 1), // R² = 0.947626
            (5, 1) => (true, false, 1.0772592, -2.8993755, 66.9794336, 1), // R² = 0.964314
            (5, 2) => (true, false, 1.0745356, 2.0312202, 71.1933486, 1), // R² = 0.960583
            (5, 3) => (true, false, 1.0579409, -0.9965567, 71.9473140, 1), // R² = 0.962005
            (5, 4) => (true, false, 1.0468408, -5.5946631, 70.8823211, 1), // R² = 0.964107
            (5, 5) => (true, false, 1.0395305, -2.9061407, 64.3691657, 1), // R² = 0.967169
            (5, 6) => (true, false, 1.0367345, -5.9854095, 53.4743744, 1), // R² = 0.967560
            (5, 7) => (false, false, 1.0562997, 0.0625395, 41.8399300, 1), // R² = 0.947476
