...
impl Thread {
    ...
    pub fn search(&mut self, depth: i32, mut alpha: i32, beta: i32, ply: usize, tt: &[TtEntry], excluded_move: Option<Move>, mut probcut_failed: bool) -> i32 {
        ...
        let (try_probcut_beta, try_probcut_alpha, a, b, sigma, s) = match (depth, piece_count, probcut_failed) {
            ...
            (6, 0, false) => (true, false, 1.0839768, 1.0473755, 53.1431137, 2), // R² = 0.975067
            (6, 1, false) => (true, false, 1.0888407, -3.9829349, 61.4371558, 2), // R² = 0.972293
            (6, 2, false) => (true, false, 1.0514865, -2.5900039, 58.5153396, 2), // R² = 0.974854
            (6, 3, false) => (true, false, 1.0359324, 0.4519571, 43.6935595, 2), // R² = 0.977044
